						...
						<form class="trip-form-area trip-page-form trip-form text-right" action="mail.php" method="post">
							...
							<div class="form-group col-md-12">
								 ...
								 <div class='input-group date' id='datetimepicker2'>
                                    <input class="form-control" id="date" name="date" placeholder="When are service needed?" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'When are service needed?'">
...
-->
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <label for="comment" class="text-white text-left">Please Describe Your Needs: - Please let us know if there is anything else required or instructions, thank you.</label>
